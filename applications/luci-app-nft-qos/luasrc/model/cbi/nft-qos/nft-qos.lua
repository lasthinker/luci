...
m = Map("nft-qos", translate("QoS Over NFT"))
...
o = s:taboption("limit", Value, "dynamic_cidr", translate("Target Network (IPv4/MASK)"), translate("Network to be applied, e.g. 192.168.2.0/24, 10.2.0.0/16, etc."))
o.datatype = "cidr4"
